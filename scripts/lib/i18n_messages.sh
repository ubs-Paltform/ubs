...
UBS_MSG_ko_STEP_BUILD_APK="Android APK 1개 빌드 중 (범용, 최적화)..."
UBS_MSG_en_STEP_BUILD_APK="Building one Android APK (universal, optimized)..."
UBS_MSG_ja_STEP_BUILD_APK="Android APK を1つビルド中（ユニバーサル、最適化）..."
UBS_MSG_zh_STEP_BUILD_APK="正在构建一个 Android APK（通用、已优化）..."
...
UBS_MSG_ko_BUILD_SUMMARY_ANDROID_APK="Android APK : %s"
UBS_MSG_en_BUILD_SUMMARY_ANDROID_APK="Android APK : %s"
UBS_MSG_ja_BUILD_SUMMARY_ANDROID_APK="Android APK : %s"
UBS_MSG_zh_BUILD_SUMMARY_ANDROID_APK="Android APK : %s"
